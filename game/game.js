...
// --- 定数 ---
const GAME_DURATION = 5;           // ★デバッグ用：5秒（本番は180）
...
// ★デバッグ用：全Night安全モード（本番は下のブロックを元に戻す）
const NIGHT_PARAMS = {
  1: {
    powerBaseDrain:     0.01,
    clockDrain:         0.1,
    clockWindPerClick:  1,
    kaaFirstMove:       [9999, 9999],
    kaaMoveInterval:    [9999, 9999],
    kaaDoorWait:        [9999, 9999],
  },
  2: {
    powerBaseDrain:     0.01,
    clockDrain:         0.1,
    ...
    kaaMoveInterval:    [9999, 9999],
    kaaDoorWait:        [9999, 9999],
    ukkichiFirstMove:     [9999, 9999],
    ukkichiMoveInterval:  [9999, 9999],
    ukkichiDoorWait:      [9999, 9999],
  },
  3: {
    powerBaseDrain:     0.01,
    clockDrain:         0.1,
    ...
    ukkichiMoveInterval:  [9999, 9999],
    ukkichiDoorWait:      [9999, 9999],
    potamaruFirstMusic:   [9999, 9999],
    potamaruMusicInterval:[9999, 9999],
    potamaruRushTime:     9999,
  },
  4: {
    powerBaseDrain:     0.01,
    clockDrain:         0.1,
